...
template
InputVec2<Kernel::Point_2>
generateInputVec2<Kernel::Point_2>(int sample_size, int seed, fixPointLocation hint, size_t x_dim, size_t y_dim);

template
InputVec2<glm::vec2>
generateInputVec2<glm::vec2>(int sample_size, int seed, fixPointLocation hint, size_t x_dim, size_t y_dim);
